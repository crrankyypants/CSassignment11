...
On my/our honor,Genavieve Middaugh, this
...
def create_graph(data):
    ...
    image_size = int(split_data[0])
    num_vert = int(split_data[1])
    ...
    for i in range(2, 2+num_vert):
        x,y,color = split_data[i]. split(",")
        vertex = ColoredVertex(i-2, int(x), int(y), color)
    ...
    return graph, int(start_index), search_color
